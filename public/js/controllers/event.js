...
.controller("popupCtrl", ['$scope', '$state', '$stateParams', '$uibModalInstance', '$window', '$timeout', 'toastr', function ($scope, $state, $stateParams, $uibModalInstance,$window, $timeout, toastr) {
                $scope.appointment = {};
                $scope.customer = [];
